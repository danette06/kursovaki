...
namespace BanduraCursovaPencil {
	...
	/// <summary>
	/// Summary for EditLead
	/// </summary>
	public ref class EditLead : public System::Windows::Forms::Form
	{
	...
	private: System::Windows::Forms::Button^ button1;
		...
		EditLead(int dId) {
			...
			command->CommandText = "SELECT * FROM Lead WHERE [Id]=@dId";
			...
			while (sqlRead->Read()) {
				textBox1->Text = System::Convert::ToString(sqlRead["Thickness"]);
				textBox2->Text = System::Convert::ToString(sqlRead["Color"]);
			}
			connect->Close();
			sqlRead->Close();
		}
		...
		int IfDuplicate()
		{
			int count;
			connect->Open();
			System::String^ query = "SELECT COUNT([Thickness]) FROM[Lead] WHERE [Thickness] = '" + textBox1->Text + "' AND [Color] = '" + textBox2->Text + "';";
			SqlCeCommand^ command = connect->CreateCommand();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Товщина стержня";
			// 
			// label4
			// 
			this->label4->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label4->Location = System::Drawing::Point(4, 58);
			this->label4->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(178, 29);
			this->label4->TabIndex = 25;
			this->label4->Text = L"Колір олівця";
			// 
			// button2
			// 
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button2->Location = System::Drawing::Point(184, 103);
			...
			this->button2->Click += gcnew System::EventHandler(this, &EditLead::button2_Click);
			// 
			// button1
			// 
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button1->Location = System::Drawing::Point(6, 103);
			...
			this->button1->Click += gcnew System::EventHandler(this, &EditLead::button1_Click);
			// 
			// EditLead
			// 
			...
			this->ClientSize = System::Drawing::Size(361, 170);
			...
			this->Name = L"EditLead";
			this->Text = L"Додати стержень олівця";
...
#pragma endregion
	...
	private: void update() {
		try {
			connect->Open();
			System::String^ query = "UPDATE Lead SET [Thickness]='" + textBox1->Text + "', [Color]='" + textBox2->Text + "' WHERE [Id]=" + this->LeadId + ";";
			SqlCeCommand^ command = connect->CreateCommand();
			command->CommandText = query;
	...
	private: void insert() {
		try {
			if (IfDuplicate() > 0)
			{
				MessageBox::Show("Такий стержень  вже існує");
				this->Close();
			}
			else
			{
				connect->Open();
				System::String^ query = "INSERT INTO Lead([Thickness], [Color])" +
